...
{
	AES("AES", "Advanced Encryption Standard (a.k.a. AES)", 128, -1, -1, 96, 128, CipherMode.SUNJCE_DEFAULT, CipherPadding.SUNJCE_DEFAULT, "SunJCE", true, false, new int[]
	{
			128, 192, 256
	}),
	...
	Threefish("Threefish", "Threefish", -1, -1, -1, 96, 128, CipherMode.BC_DEFAULT_NO_AEAD, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
			256, 512, 1024
	}),

	DES("DES", "DES", 64, 8, 64, 96, 128, CipherMode.SUNJCE_DEFAULT_NO_AEAD, CipherPadding.SUNJCE_DEFAULT, "SunJCE", true, false, 64),
	DES_EDE("DESede", "Triple-DES (a.k.a. DESede)", 64, -1, -1, 96, 128, CipherMode.SUNJCE_DEFAULT_NO_AEAD, CipherPadding.SUNJCE_DEFAULT, "SunJCE", true, false, 192),
	...
	ARIA("ARIA", "ARIA", 128, -1, -1, 96, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
			128/* , 192, 256 */
	}),

	Camellia("Camellia", "Camellia", 128, -1, -1, 96, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
			128/* , 192, 256 */
	}),
	...
	DSTU7624("DSTU7624", "DSTU7624 (a.k.a. Kalyna)", -1, -1, -1, 96, 128, CipherMode.BC_DEFAULT_NO_AEAD, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
			128, 256, 512
	}),
	GOST3412_2015("GOST3412-2015", "GOST R 34.12-2015 (a.k.a Kuznyechik)", 128, -1, -1, 96, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, 256),
	GOST28147("GOST28147", "GOST 28147 (a.k.a. Magma)", 64, -1, -1, 96, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, 256),
	...
	Rijndael("RIJNDAEL", "Rijndael", 128, -1, -1, 32, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
			128, 160, 192, 224, 256
	}),
	...
	SHACAL_2("SHACAL-2", "SHACAL-2", -1, -1, -1, 96, 128, CipherMode.BC_DEFAULT_NO_AEAD, CipherPadding.BC_DEFAULT, "BC", true, false, new int[]
	{
	...
	SM4("SM4", "SM4 (formerly SMS4)", 128, -1, -1, 96, 128, CipherMode.BC_DEFAULT, CipherPadding.BC_DEFAULT, "BC", true, false, 128),
	...
	LEA("LEA", "Lightweight Encryption Algorithm (a.k.a. LEA)", 128, -1, -1, 8, 16, new CipherMode[]
	{
